...
By utilizing the ```countplot()``` function, we can obtain a more comprehensive understanding of the parameters of the iris dataset. 
...
![Class](https://github.com/C-3sc0/pands-project/blob/main/plots/Class-countplot.png?raw=true)
